...
class CorelsClassifier:
    ...
    def fit(self, X, y, features=[], prediction_name="prediction", performRestarts=0, initNBNodes=1000, geomRReason=1.5, max_evals=1000000000, time_limit = None, nb_masks=0):
        """
        ...
        nb_masks : positive int, number of masks for DRO
        ...
        fr = fit_wrap_begin(samples.astype(np.uint8, copy=False),
                             ...
                             accuracy_upper_bound, max_evals, nb_masks)
