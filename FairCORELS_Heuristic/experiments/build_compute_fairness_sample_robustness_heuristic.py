...
from parse import *
import math
from greedy_sample_robustness_auditor import GreedySampleRobustnessAuditor
...
#exit()
#herehola
with open('results_compiled/%s_DRO_compile_eps_metric%d_%s_sample_greedy_robustness_train_epsilon_solver_%s.csv' %(dataset, fairnessMetric, heuristic, solver_arg), mode='w') as csv_file:
